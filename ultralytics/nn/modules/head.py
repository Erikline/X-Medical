...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.reg_max = 16  # DFL channels (ch[0] // 16 to scale 4/8/12/16/20 for n/s/m/l/x)             --16
        self.no = nc + self.reg_max * 4  # number of outputs per anchor                                 --144 (80 + 16*4)
        self.stride = torch.zeros(self.nl)  # strides computed during build                             --size=3
